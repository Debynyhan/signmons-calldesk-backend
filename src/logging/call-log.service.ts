...
import { CommunicationDirection, CommunicationProvider, CommunicationStatus, CommunicationChannel, Prisma } from "@prisma/client";
  ...
  private async createCommunicationEvent({
    ...
    const normalizedPayload =
      payload && typeof payload === "object"
        ? { ...(payload as Record<string, unknown>), message, role: direction === "INBOUND" ? "user" : "assistant" }
        : { message, role: direction === "INBOUND" ? "user" : "assistant" };
